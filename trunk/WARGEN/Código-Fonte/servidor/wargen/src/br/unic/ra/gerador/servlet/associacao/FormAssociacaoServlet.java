...
public class FormAssociacaoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			associacao.setModelo(ModeloController.carregarModeloPorId(Integer.parseInt(request.getParameter("modelo").toString())));
			associacao.setMarcador(MarcadorController.carregarMarcadorPorId(Integer.parseInt(request.getParameter("marcador").toString())));
			...
			associacao.setCaminhoArquivoParametros(request.getSession().getServletContext().getRealPath("\\ra\\usuarios\\" + usuario.getLogin()));
